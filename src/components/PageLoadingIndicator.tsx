...
export function PageLoadingIndicator() {
  ...
  return (
    <>
      ...
      {/* Overlay kaldırıldı - Sadece üstteki progress bar kullanılıyor */}
      {/* Blur efekti performans ve kullanıcı deneyimi için tamamen kaldırıldı */}
    </>
  );
}
...
export function LoadingSpinner({
  ...
  return (
    <div
      className={`${sizeClasses[size]} border-ai-primary/30 border-t-ai-primary rounded-full animate-spin ${className}`}
    />
  );
}
