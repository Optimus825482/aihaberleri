        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card className="border-blue-500/20 bg-gradient-to-br from-blue-500/5 to-transparent">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Bugün Yayınlanan</CardTitle>
                ...
                <Card className={cn(
                    ...
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <Activity className={cn(
                            "h-4 w-4",
                            pipeline.isProcessing ? "text-purple-500 animate-spin" : "text-muted-foreground"
                        )} />
                    </CardHeader>
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            {pipeline.queue.waiting} kuyrukta, {pipeline.queue.completed} tamamlandı
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card className="border-amber-500/20 bg-gradient-to-br from-amber-500/5 to-transparent">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Kuyruk Sağlığı</CardTitle>
                        ...
                        <div className="mt-2">
                            <Progress
                                value={pipeline.queue.completed > 0
                                    ? (pipeline.queue.completed / (pipeline.queue.completed + pipeline.queue.failed)) * 100
                                    : 100
                                }
                                className="h-1"
                            />
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                {circuit.failureRate > 0 ? `%${circuit.failureRate} hata` : "Sağlıklı"}
                                            </p>
                                        </div>
                                    </div>
                                ))}
