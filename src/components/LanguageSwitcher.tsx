...
const TurkishFlag = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
      fill="#fff"
      d="M14.201 16l-4.073 2.905 1.519-4.809-4.028-2.968 5.035-.047L14.201 6.3l1.546 4.78 5.035.047-4.028 2.968 1.519 4.809L14.201 16z"
    ></path>
    <path
      fill="#fff"
      d="M18.451 16a4.956 4.956 0 01-4.865 4.043 4.956 4.956 0 01-4.865-4.043 4.956 4.956 0 014.865-4.043 4.956 4.956 0 014.865 4.043z"
    ></path>
...
const EnglishFlag = ({ className }: { className?: string }) => (
  ...
  >
    ...
    ></path>
    <path
      d="M22.25,19h-2.5l9.934,7.947c.387-.353,.704-.777,.931-1.254l-8.365-6.693Z"
      fill="#b92932"
    ></path>
    <path
      d="M1.387,6.309l8.363,6.691h2.5L2.316,5.053c-.387,.353-.704,.777-.931,1.254v.002Z"
      fill="#b92932"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M22.25,13l9.934-7.947c-.387-.353-.704-.777-.931-1.254l-8.365,6.693-2.5,2.508h2.5-.638Z"
      fill="#b92932"
    ></path>
    <path
      d="M1.387,25.693l8.363-6.693h2.5l-9.934,7.947v-.002c.387,.353,.704,.777,.931,1.254v-.002l-.002,.002,.142-.506Z"
      fill="#b92932"
    ></path>
    ...
    ></rect>
    <path
      d="M28.222,4.21l-9.222,7.376v1.414h.75l9.943-7.94c-.419-.384-.918-.675-1.471-.85Z"
      fill="#b92932"
    ></path>
    <path
      d="M2.328,26.957c.414,.374,.904,.658,1.447,.832l9.225-7.38v-1.408h-.75L2.328,26.955v.002Z"
      fill="#b92932"
    ></path>
    <path
      d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z"
...
function getAlternateUrl(pathname: string, targetLocale: "tr" | "en"): string {
  ...
  if (pathname.startsWith("/en/")) {
    if (targetLocale === "tr") {
      // Convert /en/news/slug to /news/slug (Turkish uses same route names)
  ...
  if (targetLocale === "en") {
    // Add /en prefix (route names are the same in both locales)
