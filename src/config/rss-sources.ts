...
export const ENGLISH_SOURCES: RSSSource[] = [
  ...
  // ============================================
  // NICHE AI SOURCES (Yeni eklendi - 2025)
  // ============================================
  {
    id: "import-ai",
  ...
  },
  {
    ...
    priority: 4,
    isActive: true,
    tags: ["weekly-roundup", "curated", "comprehensive"],
  },
  {
    id: "ai-business",
    name: "AI Business",
    ...
    priority: 4,
    isActive: true,
    tags: ["enterprise-ai", "industry", "adoption"],
  },
  {
    id: "analytics-india-mag",
    ...
    priority: 3,
    isActive: true,
    tags: ["india-ai", "tutorials", "career", "news"],
  },
  {
    id: "unite-ai",
    name: "Unite.AI",
