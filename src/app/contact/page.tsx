      ...
      <div className="min-h-screen bg-ai-background-dark">
        ...
        <div className="relative overflow-hidden py-12 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            <h1 className="text-4xl md:text-5xl font-black mb-4 text-white tracking-tight">Bize Ulaşın</h1>
            <p className="text-lg text-ai-text-secondary max-w-2xl leading-relaxed">
              AI Haberleri hakkında sorularınız, iş birlikleri veya geri bildirimleriniz için buradayız.
              Teknoloji dünyasındaki en son gelişmeleri birlikte şekillendirelim.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7">
              <div className="bg-ai-surface-card border border-ai-surface-border rounded-xl p-6 md:p-8">
                <h3 className="text-xl font-bold mb-6 flex items-center gap-2 text-white">
                  <span className="material-symbols-outlined text-ai-primary">mail</span>
                  Mesaj Gönderin
                </h3>
                <ContactForm />
              </div>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              <div className="bg-ai-surface-card border border-ai-surface-border rounded-xl p-6 md:p-8 flex flex-col gap-6">
                <div>
                  <h3 className="text-xl font-bold mb-1 text-white">İletişim Bilgileri</h3>
                  <p className="text-sm text-ai-text-secondary">Doğrudan bize ulaşabileceğiniz kanallar.</p>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-ai-text-secondary leading-relaxed">
                        Maslak Mah. Büyükdere Cad. No:1,<br/>Sarıyer/İstanbul, Türkiye
                      </p>
                    </div>
                  </div>
                ...
                <div className="w-full h-48 rounded-lg overflow-hidden relative border border-ai-surface-border mt-2">
                  <div className="absolute inset-0 bg-gray-800 flex items-center justify-center">
                    <div className="text-center">
                      <span className="material-symbols-outlined text-4xl text-ai-primary mb-2 block">map</span>
                      <p className="text-sm text-ai-text-secondary">İstanbul, Türkiye</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-ai-primary to-blue-700 rounded-xl p-6 md:p-8 text-white">
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-bold mb-2">Gönüllü Ekibimize Katılın</h3>
                  <p className="text-blue-100 text-sm mb-6 leading-relaxed">
                    Yapay zeka tutkunu gönüllü yazar, editör ve araştırmacılar arıyoruz. Geleceği birlikte inşa edelim.
                  </p>
                  <a
