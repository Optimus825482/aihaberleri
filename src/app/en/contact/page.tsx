...
export const metadata: Metadata = {
  title: "Contact Us | AI News - Get in Touch",
  description:
    "Contact AI News for questions, suggestions, or partnership opportunities. We respond within 24 hours.",
  keywords: ["contact", "AI News", "get in touch", "support", "partnership"],
  alternates: {
    canonical: "https://aihaberleri.org/en/contact",
    languages: {
  ...
  openGraph: {
    ...
    description: "Get in touch with us for questions, suggestions, or partnership opportunities.",
    url: "https://aihaberleri.org/en/contact",
    siteName: "AI News",
    locale: "en_US",
    type: "website",
  },
...
const contactPageSchema = {
  ...
  "@type": "ContactPage",
  name: "AI News Contact",
  description: "Get in touch with AI News",
  url: "https://aihaberleri.org/en/contact",
  mainEntity: {
    "@type": "Organization",
    name: "AI News",
