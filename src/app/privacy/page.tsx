        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-ai-text-secondary leading-relaxed max-w-3xl">
              AI Haberleri platformunu kullanırken haklarınızı ve
              sorumluluklarınızı anlamanız bizim için önemlidir. Şeffaflık
              ilkemiz gereği tüm detayları aşağıda bulabilirsiniz.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <aside className="hidden lg:block lg:col-span-3">
              <nav className="sticky top-28 space-y-1">
                <p className="px-3 text-xs font-bold text-ai-text-muted uppercase tracking-wider mb-4">
                  İçindekiler
                </p>
                {[
            ...
            <div className="col-span-1 lg:col-span-9 space-y-16">
              ...
              <section className="scroll-mt-28" id="giris">
                <div className="flex items-center gap-4 mb-6">
                  <span className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 text-ai-primary font-bold text-lg">
                    1
                  </span>
                ...
                <div className="bg-ai-surface-card p-8 rounded-xl border border-ai-surface-border">
                  <p className="text-ai-text-secondary leading-relaxed mb-4">
                    AI Haberleri (&quot;Şirket&quot;, &quot;Biz&quot;),
                    gizliliğinize büyük önem vermektedir. Bu Gizlilik
                    Politikası, web sitemizi ziyaret ettiğinizde veya
                    hizmetlerimizi kullandığınızda kişisel verilerinizin nasıl
                    toplandığını, kullanıldığını ve korunduğunu açıklamaktadır.
                  </p>
                  <p className="text-ai-text-secondary leading-relaxed">
                    Hizmetlerimizi kullanarak, bu politikada belirtilen
                    uygulamaları kabul etmiş sayılırsınız. Bu politika, 6698
                    sayılı Kişisel Verilerin Korunması Kanunu (KVKK) ve Avrupa
                    Genel Veri Koruma Tüzüğü (GDPR) standartlarına uygun olarak
                    hazırlanmıştır.
                  </p>
                </div>
              </section>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-ai-surface-card p-6 rounded-xl border border-ai-surface-border">
                    ...
                    <p className="text-sm text-ai-text-secondary">
                      Ad, soyad, e-posta adresi ve hesap oluştururken
                      sağladığınız diğer iletişim bilgileri.
                    </p>
                  </div>
                  <div className="bg-ai-surface-card p-6 rounded-xl border border-ai-surface-border">
                    ...
                    <p className="text-sm text-ai-text-secondary">
                      IP adresi, tarayıcı türü, ziyaret edilen sayfalar ve
                      platform üzerindeki etkileşim süreleri.
                    </p>
                  </div>
                </div>
                <p className="text-ai-text-secondary leading-relaxed">
                  Topladığımız veriler, size kişiselleştirilmiş bir AI haber
                  deneyimi sunmak, teknik sorunları gidermek ve platform
                  güvenliğini sağlamak amacıyla işlenmektedir.
                </p>
              </section>
                ...
                <div className="bg-ai-primary/5 border border-ai-primary/20 rounded-xl p-6">
                  <div className="flex gap-4">
                    <div className="shrink-0">
                      <span className="material-symbols-outlined text-ai-primary text-3xl">
                        psychology
                      </span>
                    </div>
                    <div>
                      ...
                      <p className="text-ai-text-secondary text-sm mb-4">
                        AI Haberleri olarak yapay zeka teknolojilerini içerik
                        önerme ve özetleme amacıyla kullanmaktayız. Ancak,
                        kişisel verileriniz (özel mesajlar, profil detayları)
                        üçüncü taraf{" "}
                        <strong className="text-white">
                          Genel Yapay Zeka (LLM) modellerinin eğitimi için
                          kullanılmaz veya satılmaz.
                        </strong>
                      </p>
                      <ul className="space-y-2 text-sm text-ai-text-secondary">
                        <li className="flex items-start gap-2">
                          <span className="material-symbols-outlined text-green-400 text-[18px] mt-0.5">
                            check_circle
                          </span>
                          Okuma alışkanlıklarınız sadece size özel öneri
                          algoritmamızda kullanılır.
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="material-symbols-outlined text-green-400 text-[18px] mt-0.5">
                            check_circle
                          </span>
                          Verileriniz anonimleştirilerek trend analizlerinde
                          kullanılabilir.
                        </li>
                      </ul>
                    </div>
              ...
              <section className="scroll-mt-28" id="cerez">
                ...
                <div className="bg-ai-surface-card rounded-xl border border-ai-surface-border overflow-hidden">
                  {[
                    ...
                    <details
                      key={index}
                      className="group p-4 border-b border-ai-surface-border last:border-b-0"
                      open={item.open}
                    >
                      <summary className="flex cursor-pointer items-center justify-between font-medium text-white hover:text-ai-primary">
                        <div className="flex items-center gap-3">
                          <span className="material-symbols-outlined text-ai-text-muted">
                            {item.icon}
                          </span>
                ...
                <p className="text-sm text-ai-text-secondary mt-4">
                  Reklam ve analitik çerezleri için onay tercihinizi çerez
                  banner'ı üzerinden yönetebilirsiniz. Zorunlu çerezler güvenlik
                  ve temel işlevler için her zaman aktiftir.
                </p>
              </section>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex gap-3 p-4 rounded-lg bg-ai-surface-card border border-ai-surface-border">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-ai-text-muted mt-1">
                  ...
                  <div className="flex gap-3 p-4 rounded-lg bg-ai-surface-card border border-ai-surface-border">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-ai-text-muted mt-1">
                        Yanlış veya eksik bilgileri güncelleme.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-4 rounded-lg bg-ai-surface-card border border-ai-surface-border">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-ai-text-muted mt-1">
                        Hesabınızı ve verilerinizi kalıcı olarak silme.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-4 rounded-lg bg-ai-surface-card border border-ai-surface-border">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-ai-text-muted mt-1">
                        Verilerinizi başka bir servise aktarma.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-ai-primary to-blue-700 p-8 md:p-10 text-white">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-blue-100 mb-8 max-w-xl">
                      Gizlilik politikamız veya verilerinizin işlenmesi hakkında
                      herhangi bir sorunuz varsa, Veri Koruma Görevlimiz (DPO)
                      ile iletişime geçmekten çekinmeyin.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4">
                      <a
                        href="mailto:hukuk@aihaberleri.org"
                    ...
                    <div className="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between gap-4 text-sm text-blue-100">
                      <div>
                        ...
                        <p>
                          ...
                          <br />
                          Teknopark İstanbul, 34906 Pendik/İstanbul
                        </p>
                      </div>
