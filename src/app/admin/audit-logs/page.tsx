          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(stats?.actionCounts &&
                  Object.entries(stats.actionCounts)[0]?.[0]) ||
                  "N/A"}
              </div>
              <p className="text-xs text-muted-foreground">
                {(stats?.actionCounts &&
                  Object.entries(stats.actionCounts)[0]?.[1]) ||
                  0}{" "}
                kez
              </p>
            </CardContent>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(stats?.resourceCounts &&
                  Object.entries(stats.resourceCounts)[0]?.[0]) ||
                  "N/A"}
              </div>
              <p className="text-xs text-muted-foreground">
                {(stats?.resourceCounts &&
                  Object.entries(stats.resourceCounts)[0]?.[1]) ||
                  0}{" "}
                işlem
              </p>
            </CardContent>
