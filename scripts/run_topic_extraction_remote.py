...
REMOTE_DATABASE_URL = "postgresql://postgres:518518Erkan@77.42.68.4:5435/postgresainewsdb"
...
def test_connection(conn):
    ...
    cursor.execute('SELECT topic, COUNT(*) as count FROM "Article" WHERE topic IS NOT NULL GROUP BY topic ORDER BY count DESC LIMIT 5')
...
def main():
    ...
    print(f"{Colors.OKCYAN}Mode: {'TEST' if args.test else ('ALL' if args.all else f'LIMIT {args.limit}')}{Colors.ENDC}")
